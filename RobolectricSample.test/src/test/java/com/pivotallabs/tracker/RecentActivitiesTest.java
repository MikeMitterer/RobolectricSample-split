...
public class RecentActivitiesTest {
	...
	public void setUp() throws Exception {
		...
		final AuthenticationGateway authenticationGateway = new AuthenticationGateway(apiGateway, new Activity());
	...
	public void update_shouldMakeRequest() throws Exception {
		...
		final ApiRequest expectedRequest = new RecentActivityRequest("c93f12c");
	...
	public void update_shouldCreateRecentActivityObjectsFromResponse() throws Exception {
		...
		final RecentActivity recentActivity0 = recentActivities.get(0);
		assertThat(recentActivity0.getDescription(),
				equalTo("I changed the 'request' for squidward. \"Add 'Buyout'\""));

		final RecentActivity recentActivity1 = recentActivities.get(1);
	...
	public void update_shouldFireCallbacks_success() throws Exception {
		final TestCallbacks callbacks = new TestCallbacks();
